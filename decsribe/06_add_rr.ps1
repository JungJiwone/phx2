...
Add-DnsServerResourceRecordA -Name "PHX-vcsa-01" -ZoneName "vclass.local" -IPv4Address "20.20.20.20"
Add-DnsServerResourceRecordPtr -Name "20" -ZoneName "20.20.20.in-addr.arpa" -PtrDomainName "PHX-vcsa-01.vclass.local"

Add-DnsServerResourceRecordA -Name "PHX-esxi-01" -ZoneName "vclass.local" -IPv4Address "20.20.20.11"
Add-DnsServerResourceRecordPtr -Name "11" -ZoneName "20.20.20.in-addr.arpa" -PtrDomainName "PHX-esxi-01.vclass.local"

Add-DnsServerResourceRecordA -Name "PHX-esxi-02" -ZoneName "vclass.local" -IPv4Address "20.20.20.12"
Add-DnsServerResourceRecordPtr -Name "12" -ZoneName "20.20.20.in-addr.arpa" -PtrDomainName "PHX-esxi-02.vclass.local"

Add-DnsServerResourceRecordA -Name "PHX-esxi-03" -ZoneName "vclass.local" -IPv4Address "20.20.20.13"
Add-DnsServerResourceRecordPtr -Name "13" -ZoneName "20.20.20.in-addr.arpa" -PtrDomainName "PHX-esxi-03.vclass.local"
